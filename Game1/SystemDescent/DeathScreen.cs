...
{
    public class DeathScreen : BaseGame
    {
        ...
        protected override void LoadContent()
        {
            ...
            background_texture = Content.Load<Texture2D>("backgrounds/gameover");
            ...
            button_newGame.SetButtonData(button_middle, 500, "new_game", button_texture, font, "NEW GAME");
            ButtonList.Add(button_newGame);

            Button button_exitGame = new Button();  // Create exit game button
            button_exitGame.SetButtonData(button_middle, 600, "exit", button_texture, font, "EXIT");
        ...
        protected void TitleFunctions(string button_ID)
        {
            ...
            {
                RunningState.setPreviousState(3);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, "Your Score Was: " + RunningState.getScore().ToString(), new Vector2(20, 20), Color.White);
